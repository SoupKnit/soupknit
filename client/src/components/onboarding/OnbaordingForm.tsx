...
export default function OnboardingForm() {
  ...
  return (
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent size="large" className="flex h-[640px] gap-0 p-0">
        <div className="w-1/4 bg-purple-300"></div>
        <div className="flex flex-grow flex-col p-10">
          <DialogHeader>
            <DialogTitle className="text-3xl">Welcome to Soupknit</DialogTitle>
            <DialogDescription className="">
              Let&apos;s get to know you better and help you get started.
            </DialogDescription>
          </DialogHeader>
          <div className="my-auto mt-12 flex-grow space-y-6 py-6">
            {step === 1 && (
          ...
          <DialogFooter>
            {step > 1 && (
              <Button variant="brutal-outline" onClick={handlePrevious}>
                Previous
              </Button>
            )}
            {step < 3 ? (
